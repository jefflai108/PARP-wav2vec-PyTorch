...
def main(args, task=None, model_state=None):
    ...
    with torch.no_grad():
        ...
        if args.omp_cpc:
            ...
            feature_extractor_zero_rate, bert_zero_rate, total_zero_rate = \
                see_weight_rate(model, args.model_type)
...
def add_argument(parser):
    parser.add_argument('--model-type', default='wav2vec_small', choices=['wav2vec_small', 'libri960_big', 'xlsr_53_56k'],
