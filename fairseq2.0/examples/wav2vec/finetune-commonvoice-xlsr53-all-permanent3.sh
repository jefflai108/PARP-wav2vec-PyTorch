...
expdir=exp/${pretrained_model}-finetune-commonvoice-all-oneshot-permanent/${mask_name}
mask_file=exp/${pretrained_model}-finetune-commonvoice-all/oneshot-cpc/${mask_name}.pt
...
fairseq-hydra-train \
    ...
    --config-name xlsr53-2-oneshot-permanent3 \
