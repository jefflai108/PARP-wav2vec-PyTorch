...
class AudioPretrainingConfig(FairseqDataclass):
    ...
    # added option for mask_file
    mask_file: Optional[str] = field(
        default=None,
    )
    # added option for mask_file (omp+permanent)
    epoch_interval_for_pruning: Optional[int] = field(
        default=None,
    )
    # added option for mask_file (omp+permanent+growing)
    target_prune_rate: Optional[int] = field(
        default=None,
    )
