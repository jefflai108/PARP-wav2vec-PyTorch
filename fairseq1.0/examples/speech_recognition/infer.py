...
sys.path.append('/data/sls/temp/clai24/lottery-ticket/fairseq/examples/wav2vec/src')
...
def load_models_and_criterions(
    ...
    for filename in filenames:
        ...
        # there won't be error during forward pass
        if hasattr(cfg.task, 'mask_file') and cfg.task.mask_file is not None:
            model.to('cuda')
