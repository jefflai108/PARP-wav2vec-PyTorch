...
def main(cfg: DictConfig) -> None:
    ...
    # add pruning *before* dealing with modeling paralleism -- this works too
    ...
    #        model.to('cuda')
    #        mask = torch.load(cfg.task.mask_file, map_location='cuda')
    #        apply_pruning_mask(model.w2v_encoder.w2v_model, mask)
    #        feature_extractor_zero_rate, bert_zero_rate, total_zero_rate = see_weight_rate(model.w2v_encoder.w2v_model)
