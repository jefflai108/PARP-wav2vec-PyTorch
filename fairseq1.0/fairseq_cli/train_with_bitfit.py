...
def add_bitfit_argument(parser):
    ''' override pruning_methods
    '''
    parser.add_argument('--train-with-bitfit', action="store_true",
        help='train wav2vec 2.0 wiht BitFit')
    parser.add_argument('--train-with-bitfit2', action="store_true",
        help='train wav2vec 2.0 wiht BitFit2')
    parser.add_argument('--train-with-bitfit3', action="store_true",
        help='train wav2vec 2.0 wiht BitFit3')
    parser.add_argument('--train-with-bitfit4', action="store_true",
        help='train wav2vec 2.0 wiht BitFit4')
    parser.add_argument('--train-with-bitfit-random', action="store_true",
        help='train wav2vec 2.0 wiht bitfit random')

    return parser 

def cli_main(modify_parser: Optional[Callable[[argparse.ArgumentParser], None]] = None) -> None:
    parser = options.get_training_parser()
    parser = add_bitfit_argument(parser)
